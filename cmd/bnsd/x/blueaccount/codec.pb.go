...
type Domain struct {
	...
	// Valid till defines the expiration date for the domain. Expired domain
	// cannot be used or modified. None of the accounts that belong to an expired
	// domain can be used of modified as well.
	ValidTill github_com_iov_one_weave.UnixTime `protobuf:"varint,4,opt,name=valid_till,json=validTill,proto3,casttype=github.com/iov-one/weave.UnixTime" json:"valid_till,omitempty"`
}
...
func (m *Domain) GetValidTill() github_com_iov_one_weave.UnixTime {
	if m != nil {
		return m.ValidTill
	}
	return 0
...
var fileDescriptor_df2ac0ab2dae2b1e = []byte{
	...
	,
}
...
func (m *Domain) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ValidTill != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.ValidTill))
	}
	return i, nil
}
...
func (m *Domain) Size() (n int) {
	...
	if m.ValidTill != 0 {
		n += 1 + sovCodec(uint64(m.ValidTill))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ValidTill |= github_com_iov_one_weave.UnixTime(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
