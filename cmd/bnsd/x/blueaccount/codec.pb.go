...
type Domain struct {
	...
	// Valid untill defines the expiration date for the domain. Expired domain
	// cannot be used or modified. None of the accounts that belong to an expired
	// domain can be used of modified as well.
	ValidUntill github_com_iov_one_weave.UnixTime `protobuf:"varint,4,opt,name=valid_untill,json=validUntill,proto3,casttype=github.com/iov-one/weave.UnixTime" json:"valid_untill,omitempty"`
}
...
func (m *Domain) GetValidUntill() github_com_iov_one_weave.UnixTime {
	if m != nil {
		return m.ValidUntill
	}
	return 0
}
...
type RegisterDomainMsg struct {
	...
	// Client token is an arbitrary data that can be provided by a middleman
	...
	ClientToken []byte `protobuf:"bytes,4,opt,name=client_token,json=clientToken,proto3" json:"client_token,omitempty"`
}
...
func (m *RegisterDomainMsg) GetClientToken() []byte {
	if m != nil {
...
func (m *RenewDomainMsg) GetClientToken() []byte {
	if m != nil {
		return m.ClientToken
	}
	return nil
...
type RegisterAccountMsg struct {
	...
	// identify contribution of such party later.
	Targets     []BlockchainAddress `protobuf:"bytes,5,rep,name=targets,proto3" json:"targets"`
	ClientToken []byte              `protobuf:"bytes,6,opt,name=client_token,json=clientToken,proto3" json:"client_token,omitempty"`
}
...
func (m *RegisterAccountMsg) GetClientToken() []byte {
	if m != nil {
		return m.ClientToken
	}
	return nil
...
var fileDescriptor_df2ac0ab2dae2b1e = []byte{
	...
	,
}
...
func (m *Domain) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ValidUntill != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.ValidUntill))
	}
	return i, nil
}
...
func (m *RegisterDomainMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ClientToken) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintCodec(dAtA, i, uint64(len(m.ClientToken)))
...
func (m *Domain) Size() (n int) {
	...
	if m.ValidUntill != 0 {
		n += 1 + sovCodec(uint64(m.ValidUntill))
	}
	return n
}
...
func (m *Domain) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidUntill", wireType)
			}
			m.ValidUntill = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ValidUntill |= github_com_iov_one_weave.UnixTime(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
