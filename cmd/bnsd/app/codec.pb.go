...
import (
	...
	lateinit "github.com/iov-one/weave/x/lateinit"
...
type Tx_LateinitExecuteInitMsg struct {
	LateinitExecuteInitMsg *lateinit.ExecuteInitMsg `protobuf:"bytes,90,opt,name=lateinit_execute_init_msg,json=lateinitExecuteInitMsg,proto3,oneof"`
}
...
func (*Tx_LateinitExecuteInitMsg) isTx_Sum()             {}
...
func (m *Tx) GetLateinitExecuteInitMsg() *lateinit.ExecuteInitMsg {
	if x, ok := m.GetSum().(*Tx_LateinitExecuteInitMsg); ok {
		return x.LateinitExecuteInitMsg
	}
	return nil
}
...
func _Tx_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Tx_LateinitExecuteInitMsg:
		_ = b.EncodeVarint(90<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LateinitExecuteInitMsg); err != nil {
			return err
		}
	case nil:
	default:
...
func _Tx_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 89: // sum.blueaccount_update_configuration_msg
		...
		return true, err
	case 90: // sum.lateinit_execute_init_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(lateinit.ExecuteInitMsg)
		err := b.DecodeMessage(msg)
		m.Sum = &Tx_LateinitExecuteInitMsg{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Tx_OneofSizer(msg proto.Message) (n int) {
	...
	case *Tx_BlueaccountUpdateConfigurationMsg:
		...
		n += s
	case *Tx_LateinitExecuteInitMsg:
		s := proto.Size(x.LateinitExecuteInitMsg)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
type ExecuteBatchMsg_Union struct {
	...
	//	*ExecuteBatchMsg_Union_LateinitExecuteInitMsg
...
type ExecuteBatchMsg_Union_LateinitExecuteInitMsg struct {
	LateinitExecuteInitMsg *lateinit.ExecuteInitMsg `protobuf:"bytes,90,opt,name=lateinit_execute_init_msg,json=lateinitExecuteInitMsg,proto3,oneof"`
}
...
func (*ExecuteBatchMsg_Union_LateinitExecuteInitMsg) isExecuteBatchMsg_Union_Sum()             {}
...
func (m *ExecuteBatchMsg_Union) GetLateinitExecuteInitMsg() *lateinit.ExecuteInitMsg {
	if x, ok := m.GetSum().(*ExecuteBatchMsg_Union_LateinitExecuteInitMsg); ok {
		return x.LateinitExecuteInitMsg
	}
	return nil
}
...
func (*ExecuteBatchMsg_Union) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ExecuteBatchMsg_Union_OneofMarshaler, _ExecuteBatchMsg_Union_OneofUnmarshaler, _ExecuteBatchMsg_Union_OneofSizer, []interface{}{
		...
		(*ExecuteBatchMsg_Union_LateinitExecuteInitMsg)(nil),
	}
}
...
func _ExecuteBatchMsg_Union_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ExecuteBatchMsg_Union_LateinitExecuteInitMsg:
		_ = b.EncodeVarint(90<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LateinitExecuteInitMsg); err != nil {
			return err
		}
...
func _ExecuteBatchMsg_Union_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 90: // sum.lateinit_execute_init_msg
		...
		msg := new(lateinit.ExecuteInitMsg)
		err := b.DecodeMessage(msg)
		m.Sum = &ExecuteBatchMsg_Union_LateinitExecuteInitMsg{msg}
		return true, err
	default:
		return false, nil
	}
...
type ProposalOptions struct {
	...
	//	*ProposalOptions_LateinitExecuteInitMsg
...
type ProposalOptions_LateinitExecuteInitMsg struct {
	LateinitExecuteInitMsg *lateinit.ExecuteInitMsg `protobuf:"bytes,90,opt,name=lateinit_execute_init_msg,json=lateinitExecuteInitMsg,proto3,oneof"`
}
...
func (*ProposalOptions_LateinitExecuteInitMsg) isProposalOptions_Option()             {}
...
func (m *ProposalOptions) GetLateinitExecuteInitMsg() *lateinit.ExecuteInitMsg {
	if x, ok := m.GetOption().(*ProposalOptions_LateinitExecuteInitMsg); ok {
		return x.LateinitExecuteInitMsg
	}
	return nil
}
...
func (*ProposalOptions) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ProposalOptions_OneofMarshaler, _ProposalOptions_OneofUnmarshaler, _ProposalOptions_OneofSizer, []interface{}{
		...
		(*ProposalOptions_LateinitExecuteInitMsg)(nil),
	}
}
...
func _ProposalOptions_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ProposalOptions_LateinitExecuteInitMsg:
		_ = b.EncodeVarint(90<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LateinitExecuteInitMsg); err != nil {
			return err
		}
...
func _ProposalOptions_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 89: // option.blueaccount_update_configuration_msg
		...
		return true, err
	case 90: // option.lateinit_execute_init_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(lateinit.ExecuteInitMsg)
		err := b.DecodeMessage(msg)
		m.Option = &ProposalOptions_LateinitExecuteInitMsg{msg}
		return true, err
	default:
		return false, nil
	}
...
type ExecuteProposalBatchMsg_Union struct {
	...
	//	*ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg
...
type ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg struct {
	LateinitExecuteInitMsg *lateinit.ExecuteInitMsg `protobuf:"bytes,90,opt,name=lateinit_execute_init_msg,json=lateinitExecuteInitMsg,proto3,oneof"`
}
...
func (*ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg) isExecuteProposalBatchMsg_Union_Sum() {}
...
func (m *ExecuteProposalBatchMsg_Union) GetLateinitExecuteInitMsg() *lateinit.ExecuteInitMsg {
	if x, ok := m.GetSum().(*ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg); ok {
		return x.LateinitExecuteInitMsg
	}
	return nil
}
...
func (*ExecuteProposalBatchMsg_Union) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ExecuteProposalBatchMsg_Union_OneofMarshaler, _ExecuteProposalBatchMsg_Union_OneofUnmarshaler, _ExecuteProposalBatchMsg_Union_OneofSizer, []interface{}{
		...
		(*ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg)(nil),
	}
}
...
func _ExecuteProposalBatchMsg_Union_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg:
		_ = b.EncodeVarint(90<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LateinitExecuteInitMsg); err != nil {
			return err
		}
...
func _ExecuteProposalBatchMsg_Union_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 90: // sum.lateinit_execute_init_msg
		...
		msg := new(lateinit.ExecuteInitMsg)
		err := b.DecodeMessage(msg)
		m.Sum = &ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg{msg}
		return true, err
	default:
		return false, nil
	}
...
var fileDescriptor_a8efb1d2ea3c411d = []byte{
	...
	,
}
...
func (m *Tx_LateinitExecuteInitMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.LateinitExecuteInitMsg != nil {
		dAtA[i] = 0xd2
		i++
		dAtA[i] = 0x5
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.LateinitExecuteInitMsg.Size()))
		n39, err := m.LateinitExecuteInitMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *ExecuteBatchMsg_Union_LateinitExecuteInitMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.LateinitExecuteInitMsg != nil {
		dAtA[i] = 0xd2
		i++
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.LateinitExecuteInitMsg.Size()))
		n67, err := m.LateinitExecuteInitMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n67
...
func (m *ProposalOptions_LateinitExecuteInitMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.LateinitExecuteInitMsg != nil {
		dAtA[i] = 0xd2
		i++
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.LateinitExecuteInitMsg.Size()))
		n97, err := m.LateinitExecuteInitMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n97
...
func (m *ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.LateinitExecuteInitMsg != nil {
		dAtA[i] = 0xd2
		i++
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.LateinitExecuteInitMsg.Size()))
		n124, err := m.LateinitExecuteInitMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n124
...
func (m *Tx_LateinitExecuteInitMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.LateinitExecuteInitMsg != nil {
		l = m.LateinitExecuteInitMsg.Size()
		n += 2 + l + sovCodec(uint64(l))
	}
	return n
}
...
func (m *ExecuteBatchMsg_Union_LateinitExecuteInitMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProposalOptions_LateinitExecuteInitMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Tx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 90:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LateinitExecuteInitMsg", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &lateinit.ExecuteInitMsg{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Tx_LateinitExecuteInitMsg{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ExecuteBatchMsg_Union) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 90:
			...
			m.Sum = &ExecuteBatchMsg_Union_LateinitExecuteInitMsg{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCodec(dAtA[iNdEx:])
...
func (m *ProposalOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 90:
			...
			m.Option = &ProposalOptions_LateinitExecuteInitMsg{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCodec(dAtA[iNdEx:])
...
func (m *ExecuteProposalBatchMsg_Union) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 90:
			...
			m.Sum = &ExecuteProposalBatchMsg_Union_LateinitExecuteInitMsg{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCodec(dAtA[iNdEx:])
