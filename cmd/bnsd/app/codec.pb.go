...
import (
	...
	dummy "github.com/iov-one/weave/x/dummy"
...
type Tx struct {
	...
	//	*Tx_ResetRevenueMsg
	//	*Tx_UpgradeSchemaMsg
	//	*Tx_CreateCartonBoxMsg
	//	*Tx_InspectCartonBoxMsg
...
type Tx_CreateCartonBoxMsg struct {
	CreateCartonBoxMsg *dummy.CreateCartonBoxMsg `protobuf:"bytes,200,opt,name=create_carton_box_msg,json=createCartonBoxMsg,proto3,oneof"`
}
type Tx_InspectCartonBoxMsg struct {
	InspectCartonBoxMsg *dummy.InspectCartonBoxMsg `protobuf:"bytes,201,opt,name=inspect_carton_box_msg,json=inspectCartonBoxMsg,proto3,oneof"`
}
...
func (*Tx_CreateCartonBoxMsg) isTx_Sum()       {}
func (*Tx_InspectCartonBoxMsg) isTx_Sum()      {}
...
func (m *Tx) GetCreateCartonBoxMsg() *dummy.CreateCartonBoxMsg {
	if x, ok := m.GetSum().(*Tx_CreateCartonBoxMsg); ok {
		return x.CreateCartonBoxMsg
	}
	return nil
}

func (m *Tx) GetInspectCartonBoxMsg() *dummy.InspectCartonBoxMsg {
	if x, ok := m.GetSum().(*Tx_InspectCartonBoxMsg); ok {
		return x.InspectCartonBoxMsg
	}
	return nil
}
...
func (*Tx) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Tx_OneofMarshaler, _Tx_OneofUnmarshaler, _Tx_OneofSizer, []interface{}{
		...
		(*Tx_CreateCartonBoxMsg)(nil),
		(*Tx_InspectCartonBoxMsg)(nil),
	}
}
...
func _Tx_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Tx_CreateCartonBoxMsg:
		_ = b.EncodeVarint(200<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.CreateCartonBoxMsg); err != nil {
			return err
		}
	case *Tx_InspectCartonBoxMsg:
		_ = b.EncodeVarint(201<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.InspectCartonBoxMsg); err != nil {
			return err
		}
	case nil:
	default:
...
func _Tx_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 69: // sum.upgrade_schema_msg
		...
		return true, err
	case 200: // sum.create_carton_box_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(dummy.CreateCartonBoxMsg)
		err := b.DecodeMessage(msg)
		m.Sum = &Tx_CreateCartonBoxMsg{msg}
		return true, err
	case 201: // sum.inspect_carton_box_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(dummy.InspectCartonBoxMsg)
		err := b.DecodeMessage(msg)
		m.Sum = &Tx_InspectCartonBoxMsg{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Tx_OneofSizer(msg proto.Message) (n int) {
	...
	case *Tx_UpgradeSchemaMsg:
		...
		n += s
	case *Tx_CreateCartonBoxMsg:
		s := proto.Size(x.CreateCartonBoxMsg)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Tx_InspectCartonBoxMsg:
		s := proto.Size(x.InspectCartonBoxMsg)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
var fileDescriptor_e43b82f4f03f64b8 = []byte{
	...
	,
}
...
func (m *Tx_CreateCartonBoxMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.CreateCartonBoxMsg != nil {
		dAtA[i] = 0xc2
		i++
		dAtA[i] = 0xc
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.CreateCartonBoxMsg.Size()))
		n21, err := m.CreateCartonBoxMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *Tx_InspectCartonBoxMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.InspectCartonBoxMsg != nil {
		dAtA[i] = 0xca
		i++
		dAtA[i] = 0xc
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.InspectCartonBoxMsg.Size()))
		n22, err := m.InspectCartonBoxMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *Tx_CreateCartonBoxMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CreateCartonBoxMsg != nil {
		l = m.CreateCartonBoxMsg.Size()
		n += 2 + l + sovCodec(uint64(l))
	}
	return n
}
func (m *Tx_InspectCartonBoxMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Tx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 200:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreateCartonBoxMsg", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &dummy.CreateCartonBoxMsg{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Tx_CreateCartonBoxMsg{v}
			iNdEx = postIndex
		case 201:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InspectCartonBoxMsg", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &dummy.InspectCartonBoxMsg{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Tx_InspectCartonBoxMsg{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
