...
var commands = map[string]func(input io.Reader, output io.Writer, args []string) error{
	...
	"blue-delete-account":          cmdDeleteBlueAccount,
	"blue-delete-domain":           cmdDeleteBlueDomain,
	"blue-register-account":        cmdRegisterBlueAccount,
	"blue-register-domain":         cmdRegisterBlueDomain,
	"blue-replace-account-targets": cmdReplaceBlueAccountTargets,
	"blue-transfer-account":        cmdTransferBlueAccount,
	"blue-transfer-domain":         cmdTransferBlueDomain,
	"blue-update-configuration":    cmdUpdateBlueConfiguration,
	"blue-with-bc-address":         cmdWithBlueBlockchainAddress,
