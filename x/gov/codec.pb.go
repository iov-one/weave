...
type Electorate struct {
	...
	// unique identifier of the electorate.
...
type ElectionRule struct {
	...
	// unique identifier of the Elector.
...
func (m *ElectionRule) GetID() []byte {
	if m != nil {
		return m.ID
	}
	return nil
...
type TextProposal struct {
	...
	ElectionRuleID []byte `protobuf:"bytes,3,opt,name=election_rule_version_id,json=electionRuleVersionId,proto3" json:"election_rule_version_id,omitempty"`
	// The version points to a specific version in the election rule history.
	ElectionRuleVersion uint32 `protobuf:"varint,12,opt,name=election_rule_version,json=electionRuleVersion,proto3" json:"election_rule_version,omitempty"`
	...
	// The version points to a specific version in the electorate history.
	ElectorateVersion uint32 `protobuf:"varint,13,opt,name=electorate_version,json=electorateVersion,proto3" json:"electorate_version,omitempty"`
...
func (m *TextProposal) GetElectionRuleVersion() uint32 {
	if m != nil {
		return m.ElectionRuleVersion
	}
	return 0
}
...
func (m *TextProposal) GetElectorateVersion() uint32 {
	if m != nil {
		return m.ElectorateVersion
	}
	return 0
}
...
var fileDescriptor_24f6e3c5f1b82a85 = []byte{
	...
	,
}
...
func (m *TextProposal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ElectionRuleVersion != 0 {
		dAtA[i] = 0x60
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.ElectionRuleVersion))
	}
	if m.ElectorateVersion != 0 {
		dAtA[i] = 0x68
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.ElectorateVersion))
	}
	return i, nil
}
...
func (m *TextProposal) Size() (n int) {
	...
	if m.ElectionRuleVersion != 0 {
		n += 1 + sovCodec(uint64(m.ElectionRuleVersion))
	}
	if m.ElectorateVersion != 0 {
		n += 1 + sovCodec(uint64(m.ElectorateVersion))
	}
	return n
}
...
func (m *TextProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ElectionRuleVersion", wireType)
			}
			m.ElectionRuleVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCodec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ElectionRuleVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ElectorateVersion", wireType)
			}
			m.ElectorateVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCodec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ElectorateVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
