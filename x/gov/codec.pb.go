...
const (
	TextProposal_Undefined TextProposal_Status = 0
	TextProposal_Accepted  TextProposal_Status = 1
	TextProposal_Rejected  TextProposal_Status = 2
)
...
type VoteMsg_Option int32

const (
	VoteMsg_Invalid VoteMsg_Option = 0
	VoteMsg_Yes     VoteMsg_Option = 1
	VoteMsg_No      VoteMsg_Option = 2
	VoteMsg_Abstain VoteMsg_Option = 3
)

var VoteMsg_Option_name = map[int32]string{
	0: "INVALID",
	1: "YES",
	2: "NO",
	3: "ABSTAIN",
...
var VoteMsg_Option_value = map[string]int32{
	"INVALID": 0,
	"YES":     1,
	"NO":      2,
	"ABSTAIN": 3,
...
func (x VoteMsg_Option) String() string {
	return proto.EnumName(VoteMsg_Option_name, int32(x))
}

func (VoteMsg_Option) EnumDescriptor() ([]byte, []int) {
...
type TextProposal struct {
	...
	VoteResult TallyResult `protobuf:"bytes,9,opt,name=voteResult,proto3" json:"voteResult"`
	// Final result based on the votes and election rule.
	Status TextProposal_Status `protobuf:"varint,10,opt,name=status,proto3,enum=gov.TextProposal_Status" json:"status,omitempty"`
}
...
func (m *CreateTextProposalMsg) GetStartTime() uint64 {
	if m != nil {
		return m.StartTime
	}
	return 0
...
type VoteMsg struct {
	...
	Selected   VoteMsg_Option                   `protobuf:"varint,3,opt,name=selected,proto3,enum=gov.VoteMsg_Option" json:"selected,omitempty"`
}
...
func (m *VoteMsg) GetSelected() VoteMsg_Option {
	if m != nil {
		return m.Selected
	}
	return VoteMsg_Invalid
}
...
func init() {
	...
	proto.RegisterEnum("gov.VoteMsg_Option", VoteMsg_Option_name, VoteMsg_Option_value)
...
var fileDescriptor_24f6e3c5f1b82a85 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Selected |= VoteMsg_Option(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
