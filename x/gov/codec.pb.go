...
type ElectionRule struct {
	...
	// proposal this value must be exceeded with YES votes.
...
type TallyResult struct {
	...
	TotalElectorateWeight uint64 `protobuf:"varint,4,opt,name=total_electorate_weight,json=totalElectorateWeight,proto3" json:"total_electorate_weight,omitempty"`
	// QuorumThresholdWeight is the threshold in weights required to participate in the voting.
	QuorumThresholdWeight uint64 `protobuf:"varint,5,opt,name=quorum_threshold_weight,json=quorumThresholdWeight,proto3" json:"quorum_threshold_weight,omitempty"`
	// AcceptanceThresholdWeight is the threshold in weights to accept a proposal. This requires QuorumThresholdWeight
	// exceeded in total of all votes for this proposal.
	AcceptanceThresholdWeight uint64 `protobuf:"varint,6,opt,name=acceptance_threshold_weight,json=acceptanceThresholdWeight,proto3" json:"acceptance_threshold_weight,omitempty"`
}
...
func (m *TallyResult) GetQuorumThresholdWeight() uint64 {
	if m != nil {
		return m.QuorumThresholdWeight
	}
	return 0
}

func (m *TallyResult) GetAcceptanceThresholdWeight() uint64 {
	if m != nil {
		return m.AcceptanceThresholdWeight
	}
	return 0
}
...
var fileDescriptor_24f6e3c5f1b82a85 = []byte{
	...
	,
}
...
func (m *TallyResult) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.QuorumThresholdWeight != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.QuorumThresholdWeight))
	}
	if m.AcceptanceThresholdWeight != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.AcceptanceThresholdWeight))
	}
	return i, nil
}
...
func (m *TallyResult) Size() (n int) {
	...
	if m.QuorumThresholdWeight != 0 {
		n += 1 + sovCodec(uint64(m.QuorumThresholdWeight))
	}
	if m.AcceptanceThresholdWeight != 0 {
		n += 1 + sovCodec(uint64(m.AcceptanceThresholdWeight))
	}
	return n
}
...
func (m *TallyResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuorumThresholdWeight", wireType)
			}
			m.QuorumThresholdWeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCodec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QuorumThresholdWeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AcceptanceThresholdWeight", wireType)
			}
			m.AcceptanceThresholdWeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCodec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AcceptanceThresholdWeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
