...
func TestCoinsEquals(t *testing.T) {
	coinp := func(whole int64, fractional int64, ticker string) *Coin {
	...
	cases := map[string]struct {
		...
		"nil and one non zero coin": {
			a:         nil,
			b:         Coins{coinp(1, 0, "BTC")},
			wantEqual: false,
		},
		"nil and a zero value coin": {
			a:         nil,
			b:         Coins{coinp(0, 0, "BTC")},
			wantEqual: true,
		},
		"one coin in each": {
			a:         Coins{coinp(1, 3, "BTC")},
			b:         Coins{coinp(1, 3, "BTC")},
			wantEqual: true,
		},
		"the same value, different order": {
			a: Coins{
				coinp(1, 0, "BTC"),
				coinp(2, 0, "ETC"),
				coinp(3, 0, "DOGE"),
		...
		"value split into several coins": {
			a: Coins{
				coinp(6, 0, "BTC"),
				coinp(0, 2, "ETH"),
			},
		...
		"different tickers": {
			a:         Coins{coinp(1, 0, "ETC")},
			b:         Coins{coinp(1, 0, "BTC")},
			wantEqual: false,
		},
		"zero value tickers": {
			a:         Coins{coinp(0, 0, "ETC")},
			b:         Coins{coinp(0, 0, "BTC")},
			wantEqual: true,
		},
		"zero sum value tickers": {
			a: Coins{
				coinp(1, 0, "ETH"),
				coinp(-1, 0, "ETH"),
			},
