...
type AddApprovalMsg struct {
	Base nft.AddApprovalMsg `protobuf:"bytes,1,opt,name=base" json:"base"`
}
...
func (*AddApprovalMsg) Descriptor() ([]byte, []int) { return fileDescriptorCodec, []int{6} }

func (m *AddApprovalMsg) GetBase() nft.AddApprovalMsg {
	if m != nil {
		return m.Base
	}
	return nft.AddApprovalMsg{}
}

type RemoveApprovalMsg struct {
	Base nft.RemoveApprovalMsg `protobuf:"bytes,1,opt,name=base" json:"base"`
}
...
func (*RemoveApprovalMsg) Descriptor() ([]byte, []int) { return fileDescriptorCodec, []int{7} }

func (m *RemoveApprovalMsg) GetBase() nft.RemoveApprovalMsg {
	if m != nil {
		return m.Base
	}
	return nft.RemoveApprovalMsg{}
}
...
func init() {
	...
	proto.RegisterType((*RemoveApprovalMsg)(nil), "username.RemoveApprovalMsg")
}
...
var fileDescriptorCodec = []byte{
	...
	,
}
