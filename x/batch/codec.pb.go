...
func (m *ByteArrayList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ByteArrayList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ByteArrayList) XXX_DiscardUnknown() {
	xxx_messageInfo_ByteArrayList.DiscardUnknown(m)
}

var xxx_messageInfo_ByteArrayList proto.InternalMessageInfo
...
var fileDescriptor_d168b56d0e2865bf = []byte{
	...
	0x4b, 0x30, 0x2a, 0x30, 0x6b, 0xf0, 0x04, 0xc1, 0xf9, 0x4e, 0x56, 0x27, 0x1e, 0xc9, 0x31, 0x5e,
	0x78, 0x24, 0xc7, 0xf8, 0xe0, 0x91, 0x1c, 0xe3, 0x84, 0xc7, 0x72, 0x0c, 0x17, 0x1e, 0xcb, 0x31,
	0xdc, 0x78, 0x2c, 0xc7, 0x10, 0xa5, 0x90, 0x9e, 0x59, 0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f,
	0xab, 0x9f, 0x99, 0x5f, 0xa6, 0x9b, 0x9f, 0x97, 0xaa, 0x5f, 0x9e, 0x9a, 0x58, 0x96, 0xaa, 0x0f,
	0xb5, 0x3b, 0x89, 0x0d, 0x6c, 0xad, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xac, 0x31, 0x95, 0xc0,
	0x8d, 0x00, 0x00, 0x00,
}
