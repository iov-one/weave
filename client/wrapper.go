...
func (c *Client) SubscribeTxByID(ctx context.Context, info weave.BlockInfo, id TransactionID) (*CommitResult, error) {
...
func (c *Client) WatchTx(ctx context.Context, info weave.BlockInfo, id TransactionID) (*CommitResult, error) {
...
func (c *Client) CommitTx(ctx context.Context, info weave.BlockInfo, tx weave.Tx) (*CommitResult, error) {
...
func (c *Client) WatchTxs(ctx context.Context, info weave.BlockInfo, ids []TransactionID) ([]*CommitResult, error) {
...
func (c *Client) CommitTxs(ctx context.Context, info weave.BlockInfo, txs []weave.Tx) ([]*CommitResult, error) {
...
func (c *Client) WaitForHeight(ctx context.Context, info weave.BlockInfo, height int64) (*Header, error) {
	// ensure we close subscription at function return
	cctx, cancel := context.WithCancel(ctx)
	defer cancel()
