...
The signature will be saved in '${DEFAULT_BNSD_SIGS}/'. An alternative output directory
for signatures can be supplied via the environment variable \$BNSD_SIGS.
...
g_sigs_dir=${BNSD_SIGS:-"${g_workdir}/${DEFAULT_BNSD_SIGS}"}
